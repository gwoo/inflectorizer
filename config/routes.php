 ...
 */
Router::connect('/', 'Inflectorizer::index');
Router::connect('/display/{:args}.{:type}', 'Inflectorizer::display');
Router::connect('/display/{:args}', 'Inflectorizer::display');
Router::connect('/show', 'Inflectorizer::show');
Router::connect('/show/{:args}.{:type}', 'Inflectorizer::show');
